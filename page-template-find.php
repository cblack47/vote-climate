  ...
  ?>
		...
		if ( post_password_required() ) {
			echo get_the_password_form();
						...
						if (!empty($name)) {
							$candidates = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}senate WHERE Name LIKE '" . $name . "' ");
						}
						else {
						...
						if (!empty($name)) {
							$candidates = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}senate_candidates WHERE Name LIKE '" . $name . "' ");
						}
						else {
						...
						if (!empty($name)) {
							$candidates = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}house_representatives WHERE Name LIKE '" . $name . "' ");
						}
						...
						if (!empty($name)) {
							$candidates = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}house_candidates WHERE Name LIKE '" . $name . "' ");
						}
