...
<?php
/*
Template Name: Incumbent Results Page
*/
...
?>
		...
		if ( post_password_required() ) {
			echo get_the_password_form();
						...
						if (!empty($state)) {
							$candidates = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}senate_scorecard WHERE state='" . $state . "' ");
						}
						...
						$candidates = array();
						if (!empty($state)) {
							$candidates = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}senate_scorecard_new WHERE state='" . $state . "' ");
						}
						...
						if (!empty($state) && !empty($districts)) {																	
							...
							$districtString .= ')';
							$candidates = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}house_scorecard WHERE state='" . $state . "' AND " . $districtString );
						}
						else if (!empty($state)) {
							$candidates = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}house_scorecard WHERE state='" . $state . "' ");
						}
						...
						if (!empty($state) && !empty($districts)) {																	
							...
							$candidates = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}house_scorecard_new WHERE state='" . $state . "' AND " . $districtString );
						}
						else if (!empty($state)) {
							$candidates = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}house_scorecard_new WHERE state='" . $state . "' ");
						}	
